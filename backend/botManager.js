...
async function iniciarBot(empresa) {
    ...
    try {
        ...
        // ✅ PROMISE MELHORADA com timeout específico
        const qrCodePromise = new Promise((resolve, reject) => { 
            ...
            // Cleanup do timeout se a promise for resolvida
            qrCodePromise.finally(() => clearTimeout(timeoutId));
        });
        ...
        const sock = makeWASocket({
            ...
            // ✅ LOGGING REDUZIDO para melhor performance
            logger: {
                level: 'error'
            }
        });
