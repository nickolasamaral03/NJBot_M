...
//         // ✅ CONFIGURAÇÃO OTIMIZADA COM LOGGER CORRIGIDO
...
//                 }
//             },
//             // ✅ LOGGING CORRIGIDO - usar objeto simples
//             logger: {
//                 level: 'error',
//                 // ✅ REMOVER .child se existir na configuração
//                 trace: () => {},
//                 debug: () => {},
//                 info: () => {},
//                 warn: console.warn,
...
// // // Problema do Logger: Substituí a configuração do logger por um objeto simples sem o método .child
// // // Problema do qrCodePromise: Defini a variável qrCodePromise antes de criar a Promise e movi o .finally() para depois da definição
// // // Melhoria no timeout: Gerenciei melhor o cleanup do timeout
